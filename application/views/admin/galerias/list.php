          ...
          <table class="table table-striped table-bordered table-hover" id="dataTables-example">
            <thead>
              <tr>
                ...
                <th class="col-md-4" colspan="2">Opções</th>
              </tr>
            </thead>
            <tbody>
              <?php
              ...
              <tr>
                ...
                <td class="center">
                  <a href="<?php echo base_url();?>admin/galerias/editar/<?php echo $galeria->id; ?>" class="btn btn-success" data-toggle="tooltip" data-placement="top" title="Editar">
